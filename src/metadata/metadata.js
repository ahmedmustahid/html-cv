...
* Set up comprehensive development environment with code quality tools (Ruff, Basedpyright)
`,
    },
  ],
...
`,
    ...
    {
      title:
        "xiyan_mcp_server: Azure OpenAI, llama-cpp-python, & SQLite Integration",
      written: "January 2025",
      badges: [
        "Python",
        "Azure OpenAI",
      ...
      contents: `Contributed to xiyan mcp server project (Natural Language to SQL MCP server) by implementing comprehensive Azure OpenAI integration and enhancing local model support through llama-cpp-python. Enabled Streamable HTTP transport protocol and integrated SQLite database support.
...
`,
    ...
    {
      title:
        "Implemented mcp server for static error correction with basedpyright",
...
- Applied advanced statistical methods for particle physics research`,
    ...
    {
      header:
        "Conference Presentation：International Workshop on Future Linear Colliders",
      contents: `
