module.exports = {
  ...
  projects3: [
    {
      title: 'Financial AI Multi-Agent System - Backend Developer',
      written: '2024 - Present',
      badges: ['Python', 'FastAPI', 'LangChain', 'LangGraph', 'OpenAI API', 'FAISS', 'PostgreSQL', 'Pandas', 'Matplotlib', 'Docker'],
      contents: `
      Developed a sophisticated multi-agent AI system for financial data analysis and document processing using LangGraph orchestration framework. Built a scalable FastAPI backend integrating specialized AI
      agents for SQL query execution, PDF document retrieval, data visualization, and intelligent request routing. Implemented agentic RAG (Retrieval-Augmented Generation) capabilities with multilingual
      support (English/Japanese) for financial document analysis.
